...
class Eagle(Bird, discriminator="eagle"):
    ...
    :paramtype wingspan: int
    :keyword friends:
    :paramtype friends: list[~typetest.model.singlediscriminator.models.Bird]
    :keyword hate:
    :paramtype hate: dict[str, ~typetest.model.singlediscriminator.models.Bird]
    :keyword partner:
    :paramtype partner: ~typetest.model.singlediscriminator.models.Bird
    """
